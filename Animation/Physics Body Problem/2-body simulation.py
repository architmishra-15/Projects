...
h1 = [ax.scatter(r1_anim[0, 0], r1_anim[0, 1], r1_anim[0, 2], color="darkblue", marker="o", s=80,
                 label="Alpha Centauri A")]
h2 = [ax.scatter(r2_anim[0, 0], r2_anim[0, 1], r2_anim[0, 2], color="tab:red", marker="o", s=80,
